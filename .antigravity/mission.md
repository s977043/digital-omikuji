...
| Gate | タイミング | アクション |
|------|-----------|-----------|
| **Gate A** | Working Documents 作成後 | **必ず停止**し、レビューを要求する |
| Gate B | テスト作成後 | 警告を出力し、テストなしの実装を禁止 |
| Gate C | 完了報告作成後 | 警告を出力し、人間の確認を待つ |
...
2. **Phase 1 - Working Documents 作成**: 仕様書を作成し、**Gate A で停止**
